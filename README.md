...
I made layer 2 because I have two Rithmic accounts that can't run on the same instance. This lets me send orders to another NT8 instance to copy trade two Rithmic connections.
...
```csharp
private string masterAccountName = "YOUR_MASTER_ACCOUNT";
...
- Laptop: Control Center → New → Trade Copier
- Desktop: Control Center → New → Trade Copier — Receiver

---

## Roadmap

- [x] Intra-instance order copying (Layer 1)
- [x] Cross-instance order copying over LAN (Layer 2)
- [x] Modify and cancel mirroring
...
- [ ] Potentially an interface in NT8
